...
@section('content')
  ...
  <div class="container">
    <div class="row my-5 justify-content-center">
      <h1 class="col-12">Artikel Terbaru</h1>
      @foreach($Articles as $article)
        <div class="col-12 my-3">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">{{$article->title}}</h5>
              <p class="card-text">{!! Illuminate\Support\Str::words($article->content, '30') !!}</p>
              <a href="artikel/{{$article->id}}/lihat" class="btn btn-primary">Go somewhere</a>
            </div>
          </div>
        </div>
      @endforeach
